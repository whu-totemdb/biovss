...
class IndexIVFFlatMean():
    def __init__(self, dataloader = None, n_clusters = 1024, num_candidate = 20000, device = "cpu"):
    ...
    def _init_index(self):
        ...
        self.index_IVFFLAT = faiss.IndexIVFFlat(quantizer, dim, nlist, faiss.METRIC_L2)

        # 训练索引
        self.index_IVFFLAT.train(data)

        # 将数据添加到索引中
        self.index_IVFFLAT.add(data)
